<template>
  <div class="header">
    ...
    <div v-show="detailShow" class="detail" transition="fade" @click="hideDetail">
...
.header
  ...
  overflow: hidden
  color #fff
  background: rgba(7, 17, 27, 0.5) //半透明
  .content-wrapper
    position: relative//
  ...
  .bulletin-wrapper
    ...
    text-overflow ellipsis // 用省略号代表超出文章
    // font-size 0  影响省略号的显示
    background rgba(7,17,27,0.2)  //半透明效果
    .bulletin-title
      display inline-block
      vertical-align top //顶部对齐
      margin-top 8px
